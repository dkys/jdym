...
<div class="panel admin-panel">
    <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>新增客户</strong></div>
    <div class="body-content">
        <form method="post" class="form-x" action="<?php echo U('add');?>" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" name="name" data-validate="required:请输入客户名称" />
                    <div class="tips"></div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" name="mobile" data-validate="required:请输入客户手机号" />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="clear"></div>
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="" name="passport" data-validate="required:请输入客户护照编号" />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="clear"></div>
              ...
              <div class="form-group">
                ...
                <div class="field">
                    <input type="date" class="input w50" value="" name="birthday" data-validate="required:请输入客户出日期" />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="clear"></div>
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="date" class="input w50" value="" name="adddate" data-validate="required:请输入客户申请日期" />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="clear"></div>
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="" name="status" data-validate="required:请输入客户申请状态" />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="clear"></div>
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <textarea class="input w50" name="pro" cols="30" rows="5"></textarea>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="clear"></div>
