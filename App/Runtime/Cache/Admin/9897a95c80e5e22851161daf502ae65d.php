...
<form method="post" action="" id="listform">
	<div class="panel admin-panel">
		<div class="panel-head"><strong class="icon-reorder"> 项目列表</strong> <a href="add.html" style="float:right; display:none;">添加案例</a></div>
		...
		<table class="table table-hover text-center">
			...
			<volist name="list" id="vo">
				...
				<tr>
					...
					<td><img src="/jdzx/Public/Uploads/<?php echo ($v["sm_logo"]); ?>" alt="" width="70" height="50" /></td>
					<td><?php echo ($v["navtitle"]); ?></td>
