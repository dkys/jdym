...
<div class="panel admin-panel">
    <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>新增项目导航</strong></div>
    <div class="body-content">
        <form method="post" class="form-x" action="<?php echo U('add');?>" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="" name="navtitle" data-validate="required:请输入导航名称" />
                    <div class="tips"></div>
                </div>
                <br>
                <br>
                ...
                <div class="field">
                    <input type="text" class="input w50" value="" name="naventitle" data-validate="required:请输入英文名称"/>
                    <div class="tips"></div>
                </div>
                <br>
                <br>
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <select name="fenlei_id">
                            ...
                            <?php if($v["pid"] == 1 ): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["title"]); ?></option><?php endif; ?>
                                <?php endforeach; ?>
                            </OPTGROUP>
                            <OPTGROUP LABEL="移民">
                            <?php foreach($fenleiInfo as $v):?>
                               <?php if($v["pid"] == 2 ): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["title"]); ?></option><?php endif; ?>     
                            <?php endforeach; ?>
                                </OPTGROUP>
