...
<div class="panel admin-panel">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>新增新闻</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="<?php echo U('add');?>" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="entitle" data-validate="required:请输入英文名" />
        ...
        <div class="field">
          <select name="cate_id">
            ...
            <?php foreach($cateInfo as $v):?>
              <?php if($v['pid'] != 0): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["cate_name"]); ?></option>
                  <?php else: ?>
                  <option disabled="disabled" value="<?php echo ($v["url"]); ?>"><?php echo ($v["cate_name"]); ?></option><?php endif; ?>
            <?php endforeach; ?>
          </select>
          <div class="tips"></div>
        </div>
