...
<!--		<div class="header">
		...
		<div class="index">
			<div class="inner">
				您的位置：<a href="<?php echo U('Index/index');?>">首页</a> > <a href="<?php echo U('Case/cases');?>">案例展示</a> > <a href="<?php echo U('Case/casedetail');?>">案例详情</a>
			</div>
		</div>
		<!--索引结束-->
		...
		<!--案例详情开始-->
		<div class="detail">
			<div class="tit-cn"><?php echo ($info["title"]); ?></div>
			<div class="tit-en"><?php echo ($info["entitle"]); ?></div>
			<div class="cnt">
				<!--开发内容-删除掉-->
